...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Server | Komunitas GGNAEL</title>
  ...
  <body>
    ...
    <!--CONTENT-->
      ...
      function tampil_data($koneksi) {
        $sql = "SELECT * from discordserver";
        $query = mysqli_query($koneksi, $sql);

        echo "<fieldset>";
        echo "<legend><h2>Data Server</h2></legend>";
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            <tr>
                ...
                <td><a href="join?ID=<?php echo $data["server_id"];?>&invitelink=<?php echo $data["server_invite"]; urlencode($data['server_invite']); ?>"><?php echo $data['server_invite']; ?></a></td>
